...
public interface CourseSectionDao {
	...
	*获取总数量
	**/
	public Integer getItemsTotalCount(CourseSection queryEntity);

	/**
	*分页获取
	**/
	public List<CourseSection> queryCourseSectionPage(CourseSection queryEntity , TailPage<CourseSection> page);
