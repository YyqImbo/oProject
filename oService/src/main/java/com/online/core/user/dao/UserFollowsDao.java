...
public interface UserFollowsDao {
	...
	*获取总数量
	**/
	public Integer getItemsTotalCount(UserFollows queryEntity);

	/**
	*分页获取
	**/
	public List<UserFollows> queryUserFollowsPage(UserFollows queryEntity , TailPage<UserFollows> page);
